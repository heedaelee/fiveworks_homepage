...
export const eventData: EventDataType = [
  {
    ...
    FIVEWORKS는 TMMC DB를 기반으로 빅데이타 및 AI를 접목하여 성분의 작용단백질을 예측이 가능하며,  Bioinformatics 분야에 특화된 플랫폼을 만들기 위하여 'OMNIMIX-AI' 서비스를 개발하였으며 약물과 질병 간의 효능 및 작용 기전 과정을 OMNIMIX-AI를 사용하여 약물의 효능을 분석하고, 약물이 특정 질병에 미치는 영향을 데이터 기반으로 예측하여 약물의 효능 연구시 불필요한 시간을 줄이고, 
