...
const CarouselControls = ({
  ...
  return (
    <div className='embla__controls absolute top-[45%] left-[70%] w-[200px] h-[100px] flex flex-row items-center '>
      <div className='relative w-full flex flex-row justify-around'>
        ...
        <div className='flex flex-row items-baseline gap-2 text-white'>
          <div key={currentIndex} className='text-[70px] carousel-number-fade-in'>
            {currentIndex}
          </div>
