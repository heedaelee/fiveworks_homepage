...
const CarouselSlide = ({imageUrl, title, description, currentIndex}: CarouselSlideProps) => {
  return (
    <div className='embla__slide relative flex-[0_0_100%]'>
      ...
      <div className='carousel-caption  absolute top-[48%] left-[8%] xl:left-[18%] -translate-y-1/2 text-white z-50'>
        <h5 className='font-[600] text-[35px] sm:text-[48px] xl:text-[65px]'>{title}</h5>
