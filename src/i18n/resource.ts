          ...
          recruitment: {
            ...
            steps: {
              item1: {
                ...
                content2: '이메일 지원',
                list1: '포트폴리오 및 자유양식 이력서 필수 첨부',
                list2: 'Notion 양식 등으로 작성된 경우, 링크 및 문서화 PDF 모두 첨부',
              },
              item2: {
                title: '수시채용',
                content1: '특정 시기에 집중적으로 채용을 진행합니다.',
                content2: '하기 전형 절차 참조 요망',
                list1: '취업사이트를 통한 특정 시기 채용',
                list2: '필수 첨부서류는 상시채용의 내용과 동일함',
              },
            },
          },
          selection: {
          ...
          recruitment: {
            ...
            steps: {
              item1: {
                ...
                list1: 'Portfolio and free-form resume must be attached',
                list2: 'If written in Notion format, both link and documented PDF must be attached',
              },
              item2: {
                title: 'Special Recruitment',
                content1: 'Recruit intensively',
                content2: 'Please check the announcement.',
                list1: 'Recruitment at specific times through job sites',
                list2: 'The required documents are the same as regular recruitment',
              },
            },
          },
          selection: {
